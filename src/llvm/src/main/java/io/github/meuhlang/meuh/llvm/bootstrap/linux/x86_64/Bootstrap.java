 ...
 */
package io.github.meuhlang.meuh.llvm.bootstrap.linux.x86_64;
...
public class Bootstrap extends BootStrap {
    ...
    public InputStream getBootstrap() {
        return getClass().getResourceAsStream("bootstrap.llvm");
    }

    @Override
    public InputStream getSyscall() {
        return getClass().getResourceAsStream("syscall.llvm");
    }
